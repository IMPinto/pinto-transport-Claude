    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl text-secondary mb-12 max-w-lg mx-auto">
          מערכת ניהול מתקדמת לחברות הסעות - ניהול רכבים, נהגים ומסלולים במקום
          אחד
        </p>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8 text-center">
          ...
          <div className="bg-gray-900 p-6 rounded-lg">
            ...
            <p className="text-secondary text-sm">רישום ומעקב אחר כל הנהגים</p>
          </div>
          ...
          <div className="bg-gray-900 p-6 rounded-lg">
            ...
            <p className="text-secondary text-sm">תכנון ותיאום מסלולי הסעה</p>
          </div>
        </div>
      </div>
    </div>
